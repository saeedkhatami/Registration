...
class UpdateStudentComponent extends Component {
    ...
    updateStudent = (e) => {
        e.preventDefault();
        let student = {firstName: this.state.firstName, lastName: this.state.lastName, dob: this.state.dob, emailId: this.state.emailId};
                                    ...
                                    <form>
                                        ...
                                        <div className = "form-group">
                                            ...
                                            <input placeholder="Birth Date" name="birthdate" className="form-control" 
                                                value={this.state.dob} onChange={this.changeBirthDateHandler}/>
                                        </div>
                                        <div className = "form-group">
